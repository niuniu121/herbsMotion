        ...
        <div v-else class="content-wrap">
          <div class="toolbar">
            <div class="toolbar-left">
              ...
              <p>Add, edit, reorder, hide or delete large page sections and their content.</p>
            </div>
                            ...
                            <div class="qna-header-left">
                              ...
                              >
                                <div class="qna-summary-text">
                                  ...
                                  <p class="qna-summary-subtitle">
                                    {{ qna.visible ? 'Visible on website' : 'Hidden from website' }}
                                    <span v-if="qna.answer">
                                      · {{ getAnswerPreview(qna.answer) }}
                                    </span>
                                  </p>
                                </div>
                          ...
                          <div v-if="isExpanded(qna.id)" class="qna-grid">
                            <div class="form-side">
                              ...
                              <div class="form-group">
                                ...
                                <p class="helper-text">
                                  Line breaks will be preserved on the front-end QNA page.
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="preview-side">
                              <div class="preview-card">
                                <div class="preview-body">
                                  <p class="preview-role-badge">QNA Preview</p>

                                  <h4>
                                    {{ qna.question || 'Your QNA question will appear here.' }}
                                  </h4>

                                  <div class="preview-answer-wrap">
                                    <div
                                      class="preview-answer multiline-text"
                                      :class="{ collapsed: shouldShowPreviewToggle(qna.answer) }"
                                    >
                                      <p
                                        v-for="(paragraph, pIndex) in parseAnswer(qna.answer)"
                                        :key="pIndex"
                                      >
                                        {{ paragraph }}
                                      </p>
                                      ...
                                      <p
                                        v-if="!parseAnswer(qna.answer).length"
                                    ...
                                    <div
                                      v-if="
                                        shouldShowPreviewToggle(qna.answer) &&
                                        parseAnswer(qna.answer).length
                                      "
                                      class="preview-fade"
                                    ></div>
                                  </div>
                            ...
                            <div class="qna-header-left">
                              ...
                              >
                                <div class="qna-summary-text">
                                  ...
                                  <p class="qna-summary-subtitle">
                                    {{
                                      group.visible ? 'Visible on website' : 'Hidden from website'
                                    }}
                            ...
                            <div class="qna-header-left">
                              ...
                              >
                                <div class="qna-summary-text">
                                  ...
                                  <p class="qna-summary-subtitle">
                                    {{
                                      card.visible ? 'Visible on website' : 'Hidden from website'
                                    }}
                                    <span v-if="card.description">
                                      · {{ getAnswerPreview(card.description) }}
                                    </span>
                                  </p>
                                </div>
          ...
          <div class="floating-save-bar">
            <span class="floating-save-text">Changes are saved when you click Save. Deleted items save automatically.</span>
            <button class="save-btn" type="button" :disabled="saving" @click="saveContent">
              {{ saving ? 'Saving...' : 'Save QNA Page' }}
            </button>
          </div>
