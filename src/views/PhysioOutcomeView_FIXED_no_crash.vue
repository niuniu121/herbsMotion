...
const physioConditions = [
  ...
  },,
  {
    ...
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for Hip Surgery',
    expect:
    ...
    research: {
      summary:
        'Exercise-based rehabilitation after hip surgery improves strength, mobility, and functional outcomes, especially when progressed appropriately.',
      references: [
        'Pozzi, F., Snyder-Mackler, L., & Zeni, J. (2013). Physical exercise after hip arthroplasty. Journal of Orthopaedic & Sports Physical Therapy, 43(11), 825–837.',
      ],
    },
    time: '3–6 months',
    timeUnit: 'months',
    ...
    noTreatNum: 68,
    sustained: '72% / 85% / 90%',
    manualRole: 'Reduces stiffness and supports early pain control.',
    exerciseRole: 'Rebuilds hip strength, walking control and daily function.',
    speedUp: [
      {
        title: 'Early Mobilisation',
        desc: '• Gentle movement and walking practice help restore confidence.\n• Early safe activity supports smoother functional recovery.',
      },
      {
        title: 'Consistent Strengthening',
        desc: '• Hip, core and balance exercises improve walking quality.\n• Following precautions and managing swelling usually supports better progress.',
      },
    ],
    slowDown: [
      {
        title: 'Poor Exercise Adherence',
        desc: '• Inconsistent rehab can leave weakness and poor walking patterns.\n• Missing key exercises often slows return to daily activity.',
      },
      {
        title: 'Returning Too Early',
        desc: '• Overloading before strength and balance return can create setbacks.\n• Fear of movement or complications may also slow recovery.',
      },
    ],
  },
  {
    id: 'kneesurgeryrehabilitation',
    name: 'Knee Surgery Rehabilitation',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for Knee Surgery',
    expect:
    ...
    research: {
      summary:
        'Structured physiotherapy is essential after knee surgery to restore motion, strength, and functional performance.',
      references: [
        'Artz, N., Elvers, K. T., Lowe, C. M., et al. (2015). Effectiveness of physiotherapy exercise following knee arthroplasty. BMC Musculoskeletal Disorders, 16, 15.',
      ],
    },
    time: '3–6 months',
    timeUnit: 'months',
    ...
    noTreatNum: 60,
    sustained: '68% / 82% / 90%',
    manualRole: 'Reduces stiffness and supports range-of-motion recovery.',
    exerciseRole: 'Progressive quadriceps and functional strengthening restores control.',
    speedUp: [
      {
        title: 'Early Range-of-Motion Work',
        desc: '• Restoring bend and straightening early reduces stiffness risk.\n• Swelling control helps the quadriceps activate better.',
      },
      {
        title: 'Gradual Return to Activity',
        desc: '• Walking, stairs and strength work should progress in stages.\n• Consistency supports stronger long-term knee function.',
      },
    ],
    slowDown: [
      {
        title: 'Persistent Swelling',
        desc: '• Ongoing swelling can inhibit muscle activation.\n• It often makes the knee feel weak and slow to trust.',
      },
      {
        title: 'Delayed Movement or Inconsistent Rehab',
        desc: '• Waiting too long to move may increase stiffness.\n• Fear avoidance and irregular exercises can delay function.',
      },
    ],
  },
  {
    id: 'shouldersurgeryrehabilitation',
    name: 'Shoulder Surgery Rehabilitation',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for Shoulder Surgery',
    expect:
    ...
    research: {
      summary:
        'Rehabilitation following shoulder surgery improves pain, mobility, and function, particularly with staged exercise progression.',
      references: [
        'Kuhn, J. E. (2009). Exercise in shoulder rehabilitation. Journal of Shoulder and Elbow Surgery, 18(1), 138–160.',
      ],
    },
    time: '4–9 months',
    timeUnit: 'months',
    ...
    noTreatNum: 53,
    sustained: '60% / 78% / 85%',
    manualRole: 'Supports pain control and safe mobility recovery.',
    exerciseRole: 'Staged strengthening restores shoulder stability and function.',
    speedUp: [
      {
        title: 'Following Sling Protocols',
        desc: '• Respecting surgical timelines protects healing tissue.\n• The right amount of movement helps avoid unnecessary stiffness.',
      },
      {
        title: 'Gradual Exercise Progression',
        desc: '• Mobility, strength and function should build step by step.\n• Consistent exercises usually improve confidence with arm use.',
      },
    ],
    slowDown: [
      {
        title: 'Early Overuse',
        desc: '• Loading the shoulder too soon may irritate healing tissue.\n• Re-injury or poor compliance can delay functional recovery.',
      },
      {
        title: 'Inadequate Strength Progression',
        desc: '• Stiffness and weak shoulder control can limit return to activity.\n• Progress often slows when strength is not rebuilt gradually.',
      },
    ],
  },
  {
    id: 'lowerlimbfracture',
    name: 'Lower Limb Fracture (Hip, Knee, Ankle)',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for Lower Limb Fractures',
    expect:
    ...
    research: {
      summary:
        'Rehabilitation after lower limb fractures improves walking ability, strength, and independence, particularly in older adults.',
      references: [
        'Handoll, H. H., Sherrington, C., & Mak, J. C. (2011). Interventions for improving mobility after hip fracture surgery. Cochrane Database of Systematic Reviews, (3).',
      ],
    },
    time: '3–12 months',
    timeUnit: 'months',
    ...
    noTreatNum: 60,
    sustained: '62% / 78% / 88%',
    manualRole: 'Assists joint mobility and early stiffness management.',
    exerciseRole: 'Rebuilds strength, balance, gait and safe weight-bearing capacity.',
    speedUp: [
      {
        title: 'Safe Weight-Bearing Progression',
        desc: '• Gradual loading helps restore walking confidence.\n• Progress should match healing stage and medical guidance.',
      },
      {
        title: 'Strength + Balance Training',
        desc: '• Stronger legs and better balance reduce falls risk.\n• Consistent exercise supports independent mobility.',
      },
    ],
    slowDown: [
      {
        title: 'Prolonged Immobility',
        desc: '• Too much rest can reduce strength and confidence.\n• Low activity levels often make walking recovery slower.',
      },
      {
        title: 'Fear of Weight-Bearing',
        desc: '• Avoiding load for too long may delay normal gait.\n• Poor balance can keep daily movement feeling unsafe.',
      },
    ],
  },
  {
    id: 'upperlimbfracture',
    name: 'Upper Limb Fracture (Wrist, Arm, Shoulder)',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for Upper Limb Fractures',
    expect:
    ...
    research: {
      summary:
        'Early mobilisation and rehabilitation improve outcomes after upper limb fractures, particularly in restoring movement and function.',
      references: [
        'Wakefield, A. E., & McQueen, M. M. (2000). The role of physiotherapy in wrist fracture recovery. Journal of Bone and Joint Surgery, 82(7), 972–976.',
      ],
    },
    time: '2–6 months',
    timeUnit: 'months',
    ...
    noTreatNum: 65,
    sustained: '70% / 82% / 90%',
    manualRole: 'Helps reduce stiffness and restore joint mobility.',
    exerciseRole: 'Restores strength, hand use and functional arm control.',
    speedUp: [
      {
        title: 'Early Mobilisation',
        desc: '• Safe movement helps reduce stiffness.\n• Using the hand and arm appropriately supports function.',
      },
      {
        title: 'Consistent Strengthening',
        desc: '• Regular exercises rebuild grip, arm strength and confidence.\n• Functional practice helps daily tasks feel easier.',
      },
    ],
    slowDown: [
      {
        title: 'Prolonged Immobilisation',
        desc: '• Staying still for too long can increase joint stiffness.\n• Swelling may also make movement feel harder.',
      },
      {
        title: 'Poor Compliance',
        desc: '• Irregular rehab can delay strength and range recovery.\n• Function often lags when exercises are not repeated consistently.',
      },
    ],
  },
  {
    ...
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for BPPV',
    expect:
    ...
    research: {
      summary:
        'Repositioning manoeuvres are highly effective and are considered first-line treatment for BPPV.',
      references: [
        'Bhattacharyya, N., Gubbels, S. P., Schwartz, S. R., et al. (2017). Clinical practice guideline: BPPV. Otolaryngology–Head and Neck Surgery, 156(3_suppl), S1–S47.',
      ],
    },
    time: '1–14 days',
    timeUnit: 'days',
    ...
    noTreatNum: 45,
    sustained: '90% / 85% / 78%',
    manualRole: 'Repositioning manoeuvres help move inner-ear crystals.',
    exerciseRole: 'Movement advice and follow-up reduce fear and recurrence impact.',
    speedUp: [
      {
        title: 'Early Diagnosis',
        desc: '• Correct positional testing helps identify BPPV quickly.\n• Timely treatment often leads to rapid symptom improvement.',
      },
      {
        title: 'Correct Manoeuvre Technique',
        desc: '• Accurate repositioning is central to recovery.\n• Follow-up helps if symptoms persist or recur.',
      },
    ],
    slowDown: [
      {
        title: 'Incorrect Diagnosis',
        desc: '• Other dizziness causes need different management.\n• Mislabelled symptoms can delay useful treatment.',
      },
      {
        title: 'Avoiding Movement',
        desc: '• Anxiety about dizziness can reduce normal movement confidence.\n• Recurrent BPPV may also need reassessment.',
      },
    ],
  },
  {
    id: 'vestibularneuritis',
    name: 'Vestibular Neuritis',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for Vestibular Neuritis',
    expect:
    ...
    research: {
      summary:
        'Vestibular rehabilitation is strongly recommended and improves dizziness, balance, and function.',
      references: [
        'Hall, C. D., Herdman, S. J., Whitney, S. L., et al. (2022). Vestibular rehabilitation guideline. Journal of Neurologic Physical Therapy, 46(2), 118–177.',
      ],
    },
    time: '6–12 wks',
    timeUnit: 'weeks',
    ...
    noTreatNum: 50,
    sustained: '78% / 82% / 85%',
    manualRole: 'Supports symptom assessment and safe movement exposure.',
    exerciseRole: 'Gaze stabilisation and balance training drive compensation.',
    speedUp: [
      {
        title: 'Consistent Vestibular Exercises',
        desc: '• Gaze and balance practice helps the brain adapt.\n• Regular repetition usually improves dizziness tolerance.',
      },
      {
        title: 'Staying Active',
        desc: '• Walking and gradual movement exposure support compensation.\n• Early movement often prevents prolonged sensitivity.',
      },
    ],
    slowDown: [
      {
        title: 'Avoiding Movement',
        desc: '• Too much rest can keep dizziness sensitivity high.\n• Fear of symptoms often slows balance recovery.',
      },
      {
        title: 'Anxiety or Migraine Factors',
        desc: '• Anxiety and migraine can amplify dizziness symptoms.\n• Inconsistent exercises may make progress feel stop-start.',
      },
    ],
  },
  {
    id: 'dizzinessafterstroke',
    name: 'Dizziness After Stroke',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist for Post-Stroke Dizziness',
    expect:
    ...
    research: {
      summary:
        'Exercise-based and vestibular rehabilitation can improve balance and functional outcomes after stroke.',
      references: [
        'An, M., & Shaughnessy, M. (2011). Exercise-based rehabilitation for stroke. Journal of Neuroscience Nursing, 43(6), 298–307.',
      ],
    },
    time: '4–12 wks',
    timeUnit: 'weeks',
    ...
    noTreatNum: 35,
    sustained: '55% / 65% / 70%',
    manualRole: 'Guides safe movement exposure and symptom monitoring.',
    exerciseRole: 'Balance, walking and gaze exercises rebuild stability.',
    speedUp: [
      {
        title: 'Early Rehabilitation',
        desc: '• Regular balance and walking practice supports adaptation.\n• Repetition helps rebuild confidence in daily movement.',
      },
      {
        title: 'Family Support',
        desc: '• Support at home can increase practice and safety.\n• Consistent encouragement helps reduce fear of movement.',
      },
    ],
    slowDown: [
      {
        title: 'Severe Stroke or Fatigue',
        desc: '• Greater neurological impact can slow balance recovery.\n• Fatigue may reduce practice tolerance.',
      },
      {
        title: 'Fear of Falling or Visual Deficits',
        desc: '• Fear can reduce useful movement exposure.\n• Vision changes and low activity levels may limit progress.',
      },
    ],
  },
  {
    id: 'strokerehabilitation',
    name: 'Stroke Rehabilitation and Recovery',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist',
    expect:
    ...
    research: {
      summary:
        'Exercise-based stroke rehabilitation can improve balance and walking capacity, especially when training is specific, repetitive, and started early where medically appropriate.',
      references: [
    ...
    noTreatNum: 35,
    sustained: '52% / 65% / 72%',
    manualRole: 'Assists mobility, tone management and comfort where appropriate.',
    exerciseRole: 'Task-specific practice improves walking, balance and independence.',
    speedUp: [
      {
        title: 'High-Repetition Practice',
        desc: '• Repeated task-specific practice drives functional change.\n• Goal-based training helps translate gains into daily life.',
      },
      {
        title: 'Supportive Recovery Routine',
        desc: '• Family support, good sleep and home practice improve consistency.\n• Cardiovascular fitness can support broader recovery capacity.',
      },
    ],
    slowDown: [
      {
        title: 'Neurological Complexity',
        desc: '• Severe stroke, neglect or cognitive impairment can slow progress.\n• Spasticity and pain may limit movement quality.',
      },
      {
        title: 'Fatigue or Low Support',
        desc: '• Depression, fatigue and low motivation can reduce practice.\n• Lack of support often makes home follow-through harder.',
      },
    ],
  },
  {
    ...
    research: {
      summary:
        'Clinical guidelines support physiotherapy for Parkinson’s disease, particularly exercise, balance training, gait training, and task-specific movement strategies to improve mobility and reduce disability.',
      references: [
        'Osborne, J. A., Botkin, R., Colon-Semenza, C., et al. (2022). Physical therapist management of Parkinson disease: A clinical practice guideline from the American Physical Therapy Association. Physical Therapy, 102(4), pzab302.',
      ],
    },
    time: '6–12 wks',
    timeUnit: 'weeks',
    ...
    noTreatNum: 30,
    sustained: '60% / 65% / 60%',
    manualRole: 'Supports flexibility, comfort and movement preparation.',
    exerciseRole: 'Strength, balance, gait and cueing strategies maintain mobility.',
    speedUp: [
      {
        title: 'Regular Exercise',
        desc: '• Strength, balance and walking practice help maintain function.\n• Ongoing exercise is important because Parkinson’s is progressive.',
      },
      {
        title: 'Cueing + Medication Timing',
        desc: '• Cueing strategies can improve gait and freezing episodes.\n• Aligning practice with medication timing may improve movement quality.',
      },
    ],
    slowDown: [
      {
        title: 'Advanced Disease or Freezing',
        desc: '• More advanced symptoms can increase falls risk.\n• Freezing of gait may require more targeted strategies.',
      },
      {
        title: 'Low Activity or Poor Sleep',
        desc: '• Inconsistent exercise can accelerate functional decline.\n• Cognitive changes and medication fluctuations may also affect progress.',
      },
    ],
  },
  {
    id: 'fallsandbalanceissues',
    name: 'Falls and Balance Issues',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist',
    expect:
    ...
    research: {
      summary:
        'Exercise programs reduce falls in community-dwelling older adults, with larger benefits when exercises challenge balance and are performed for sufficient weekly duration.',
      references: [
        'Sherrington, C., Fairhall, N. J., Wallbank, G. K., et al. (2017). Exercise to prevent falls in older adults: An updated systematic review and meta-analysis. British Journal of Sports Medicine, 51(24), 1750–1758.',
      ],
    },
    time: '8–12 wks',
    timeUnit: 'weeks',
    medianValue: 10,
    axisMax: 12,
    physioRate: '20% – 40% risk reduction',
    physioRateNum: 40,
    noTreatment: 'Risk unchanged/increases',
    noTreatNum: 15,
    sustained: '60% / 70% / 72%',
    manualRole: 'Assists comfort and movement readiness where appropriate.',
    exerciseRole: 'Balance-challenging and strength exercises reduce falls risk.',
    speedUp: [
      {
        title: 'Balance-Challenging Exercise',
        desc: '• Exercises need to safely challenge balance reactions.\n• Regular practice improves confidence and control.',
      },
      {
        title: 'Strength + Home Safety',
        desc: '• Stronger legs support safer walking and transfers.\n• Footwear, vision checks and home changes can reduce risk.',
      },
    ],
    slowDown: [
      {
        title: 'Fear of Falling',
        desc: '• Fear can reduce activity and weaken balance further.\n• Low confidence often limits useful practice.',
      },
      {
        title: 'Dizziness or Unsafe Environment',
        desc: '• Poor vision, dizziness or sedating medications can raise risk.\n• Unsafe home layouts and inconsistent exercise slow improvement.',
      },
    ],
  },
  {
    id: 'paediatricgrossmotordelay',
    name: 'Paediatrics: Gross Motor Delay',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist',
    expect:
    ...
    research: {
      summary:
        'Research supports task-oriented and activity-based motor interventions for children with motor delays or coordination difficulties, especially when therapy is practical, repetitive, and linked to real-life play activities.',
      references: [
        'Alghadier, M., & Alhusayni, A. I. (2024). Evaluating the efficacy of gross-motor-based interventions for children with developmental coordination disorder: A systematic review. Journal of Clinical Medicine, 13(16), 4609.',
      ],
    },
    time: '3–12 months',
    timeUnit: 'months',
    ...
    noTreatNum: 45,
    sustained: '55% / 70% / 80%',
    manualRole: 'Supports positioning, comfort and movement preparation where needed.',
    exerciseRole: 'Play-based strengthening builds motor skills and confidence.',
    speedUp: [
      {
        title: 'Early Intervention',
        desc: '• Earlier support can build age-appropriate movement habits.\n• Parent-led daily practice makes therapy more effective.',
      },
      {
        title: 'Play-Based Strengthening',
        desc: '• Tummy time, balance games and movement play support milestones.\n• Consistent routines help children practise without pressure.',
      },
    ],
    slowDown: [
      {
        title: 'Limited Floor Time',
        desc: '• Too little active play can reduce movement confidence.\n• Excessive equipment use may limit natural practice opportunities.',
      },
      {
        title: 'Underlying Development Factors',
        desc: '• Low tone, prematurity or neurological conditions may slow progress.\n• Missed appointments and inconsistent home practice also reduce gains.',
      },
    ],
  },
  {
    id: 'plagiocephalyandtorticollis',
    name: 'Plagiocephaly and Torticollis',
    expectTitle: 'What to Expect When You Visit Our Physiotherapist',
    expect:
    ...
    research: {
      summary:
        'Clinical guidelines state that most positional plagiocephaly improves with counter-positioning and physiotherapy, while congenital muscular torticollis often responds well to stretching and physiotherapy when started early.',
      references: [
        'Royal Children’s Hospital Melbourne. (2024). Clinical practice guidelines: Positional plagiocephaly.',
        'Royal Children’s Hospital Melbourne. (2024). Clinical practice guidelines: Congenital torticollis.',
      ],
    },
    time: '2–6 months',
    timeUnit: 'months',
    ...
    noTreatNum: 63,
    sustained: '75% / 88% / 90%',
    manualRole: 'Gentle stretching and positioning advice improve symmetry.',
    exerciseRole: 'Tummy time and play-based strengthening support development.',
    speedUp: [
      {
        title: 'Early Treatment',
        desc: '• Earlier assessment usually improves neck mobility faster.\n• Parent-led positioning and stretches support daily progress.',
      },
      {
        title: 'Frequent Tummy Time',
        desc: '• Tummy time encourages strength and pressure relief.\n• Varied positioning helps reduce persistent one-sided preference.',
      },
    ],
    slowDown: [
      {
        title: 'Late Presentation',
        desc: '• Established tightness or head-shape change may need longer care.\n• Severe neck restriction can slow symmetry recovery.',
      },
      {
        title: 'Low Tummy Time Tolerance',
        desc: '• Limited practice can delay strength and motor progress.\n• Prematurity or developmental delay may also affect recovery speed.',
      },
    ],
  },
]
...
const sortedConditions = computed(() => {
  return [...physioConditions]
    .filter((condition) => condition && condition.id && condition.name)
    .sort((a, b) => a.name.localeCompare(b.name, 'en', { sensitivity: 'base' }))
})

const selectedId = ref(physioConditions.find((condition) => condition && condition.id)?.id || '')

const selectedData = computed(() => {
  return (
    physioConditions.find((condition) => condition && condition.id === selectedId.value) ||
    sortedConditions.value[0] ||
    {}
  )
})
