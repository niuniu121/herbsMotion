      ...
      >
        <div class="container">
          ...
          <p class="hero-subtitle">
            Practical guidance on how to take granulated herbs and herbal pills, what to avoid, and
            how to support your treatment through food, rest, and daily habits.
          </p>
        </div>
      </section>
          ...
          <div class="qna-shell">
            <div class="qna-intro-card">
              ...
              <div>
                ...
                <p>
                  Please follow your practitioner’s instructions. If you feel unwell, stop taking
                  the herbs and seek medical advice when needed.
                </p>
              </div>
            </div>
          ...
          <div class="qna-shell food-shell">
            <div class="qna-intro-card">
              ...
              <div>
                ...
                <p>
                  These foods may be unsuitable during herbal treatment depending on your condition
                  and prescription.
                </p>
              </div>
            </div>
            ...
            <div class="food-grid">
              <article v-for="group in avoidGroups" :key="group.title" class="food-card">
                <h3>{{ group.title }}</h3>
                <ul>
          ...
          <div class="qna-shell lifestyle-shell">
            <div class="qna-intro-card">
              ...
              <div>
                ...
                <p>
                  Herbal treatment works best when supported by steady routines, adequate rest, and
                  calm daily habits.
                </p>
              </div>
            </div>
            ...
            <div class="lifestyle-grid">
              <article class="lifestyle-card">
                ...
                <p>
                  Balance work and rest, avoid overworking, keep warm after sweating, and avoid
                  smoking.
                </p>
              </article>
              ...
              <article class="lifestyle-card">
                ...
                <p>
                  Maintain a positive mood, stay calm and relaxed, and avoid anger and stress where
                  possible.
                </p>
              </article>
            </div>
